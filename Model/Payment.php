<?php
/**
* SEQR_Plugin default configuration
*
* @category    SEQR
* @package     SEQR_Plugin
* @author      Marek Ordon
* @copyright   SEQR Poland
...
//         ) {
//         	$this->_logger->debug(__('return false 1'));
//             return false;
//         }

// //         if (!$this->getConfigData('api_key')) {
// //         	$this->_logger->debug(__('return false 2'));
// //             return false;
// //         }
//         $this->_logger->debug(parent::isAvailable($quote));
//         return parent::isAvailable($quote);
		
    	
    	$this->_logger->debug($this->getConfigData('soap_url'));
    	
    	if($this->getConfigData('active')){
    		$this->_logger->debug(__('return true'));
			return true;
    	} else {
    		$this->_logger->debug(__('return false'));
    		return false;
    	}
    }
    ...
    {
//     	$this->_logger->debug(__('canUseForCurrency'));
